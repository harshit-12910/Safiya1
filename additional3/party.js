console.log("JavaScript is connected!");
  ...
  function updatePlayPauseButton() {
    if (!audioPlayerElement.paused && audioPlayerElement.readyState > 2) { // Check if playing and data is loaded
      playPauseBtn.querySelector('img').src = "additional3/buttons3/pause.png"; // Set to pause icon
    } else {
      playPauseBtn.querySelector('img').src = "additional3/buttons3/play.png"; // Set to play icon
    }
  }
  ...
  function playPause() {
    if (audioPlayerElement.paused || audioPlayerElement.readyState === 0) {
      ...
      playPauseBtn.querySelector('img').src = "additional3/buttons3/pause.png"; // Set to pause on play
    } else {
      audioPlayerElement.pause();
      playPauseBtn.querySelector('img').src = "additional3/buttons3/play.png"; // Set to play on pause
    }
  }
  ...
  function playNext() {
    if (currentSongIndex < items.length - 1) {
      ...
      playPauseBtn.querySelector('img').src = "additional3/buttons3/pause.png";
    }
  }
